// path: src/components/dashboard/columns/DocumentsColumn.tsx
...
export function DocumentsColumn({ path }: DocumentsColumnProps) {
  return (
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        <p className={styles.placeholder}>Documents coming soon</p>
      </div>
    </div>
  );
}
